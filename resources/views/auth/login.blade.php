...
<html lang="en" data-bs-theme="auto">
    <head><script src="/assets_admin/js/color-modes.js"></script>
    ...
    <link href="/assets_admin/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="text-center">
                <img class="mb-4" src="/assets_admin/images/logo-polos.png" alt="" width="100">
            </div>
        ...
        <script src="/assets_admin/dist/js/bootstrap.bundle.min.js"></script>
